...
### 
/en Final participant check-in. /;
/fr Enregistrement final du participant. /;
...
Q: 
/en What platforms did you use to participate in #Learn4PE? Choose all that apply /;
/fr De quelle façon avez-vous participé? /;
/any
/en Online via Moodle /; /fr En ligne via Moodle /;
/en WebEx /; /fr WebEx /;
/en Teleconference /; /fr Teleconference /;
;
...
/fr Nous aimerions en savoir plus! Voulez-vous nous dire pourquoi vous avez donné la note que vous avez choisie ? /;
/open
...
Q:
/en Is there something you can take away from your experience that will help you in your work?  /;
/fr Y a-t-il quelque chose que vous pouvez retirer de votre expérience et qui vous aidera dans votre travail? /;
/ONE
/en Yes /; /fr Oui /; 
/en No /; /fr Non /; 
;
...
Q: 
/en If no, would you be willing to tell us more about why not? /;
/fr Dans la négative, seriez-vous prêt à nous en dire plus à ce sujet ? /;
/open

Q: 
/en What would you still like to learn or develop in relation to Public Engagement? /;
/fr Qu'aimeriez-vous encore apprendre ou développer en matière de participation du public ? /;
/open

Q: 
/en Are there factors that may influence your ability to put Learn4PE insights in practice? If yes, what are they? /;
/fr Y a-t-il des facteurs qui peuvent influencer votre capacité à mettre en pratique les idées de Learn4PE ? Si oui, quelles sont-elles ? /;
/open
