...
/fr Compétences et apprentissage – DevOps /;
...
// /en Please rank your knowledge of the following 10 devops competencies on a scale of 0-5 /; /fr Veuillez évaluer vos connaissances à l’égard des dix compétences suivantes liées à la méthode DevOps sur une échelle de 0 à 5. /; 
<ul>
<li>/en 0 - I don’t understand or do not yet possess this competence /; /fr  0 - Je ne comprends pas ce que c’est ou je ne possède pas encore cette compétence. /; </li>
<li>/en 1 - Novice: I have a basic understanding of this competence /; /fr 1 - Novice: J’ai une compréhension de base de cette notion. /; </li>
<li>/en 2 - Advanced beginner: I can demonstrate this competence under supervision /; /fr 2 - Débutant avancé: Je peux utiliser cette compétence sous supervision. /; </li>
<li>/en 3 - Competent: I can demonstrate this competence independently /; /fr 3 - Compétent: Je peux utiliser cette compétence de manière autonome. /; </li>
<li>/en 4 - Proficient: I can mentor other people in this competence /; /fr 4 - Très compétent: Je peux servir de mentor à d’autres personnes relativement à cette compétence. /; </li>
<li>/en 5 - Expert: I develop new ways of applying this competence /; /fr 5 - Expert: Je conçois de nouvelles façons d’utiliser cette compétence. /; </li>
</ul>
...
// /en Provide additional context for your skills /; /fr Renseignements supplémentaires concernant vos compétences /;
...
/fr Parmi les outils suivants, lesquels maîtrisezvous /;
/any
/en Git Command Line Interface /; /fr Interface en ligne de commande Git /;
/en GitHub /; /fr GitHub /;
/en GitLab /; /fr GitLab /;
...
/en AWS cloud /; /fr Nuage Amazon Web Services (AWS) /;
/en Azure cloud /; /fr Nuage Microsoft Azure /;
...
/fr Maîtrisezvous d’autres outils ou technologies liés à la méthode DevOps ? Inscrire les outils et les technologies que vous êtes à l’aise d’utiliser (niveaux 3 à 5 – compétent, très compétent ou expert) /;
/open

*Q: 
/en How did you acquire most of your existing programming skills? Select all options that apply /; 
/fr De quelle façon avezvous acquis la plupart de vos compétences actuelles en programmation /;
/any
/en On my own initiative /; /fr Par moimême /;
/en On the job /; /fr Au travail /;
/en Through formal education /; /fr Dans le cadre de mes études /;
;

/pagebreak

// /en Tell us about how you learn /; /fr Façon d’apprendre /;

*Q: 
/en What resources do you use today to learn new about DevOps? /; 
/fr Quelles ressources utilisezvous, actuellement, pour en apprendre davantage concernant la méthode DevOps? /;
/any
...
*Q: /en How do you prefer to learn? /; /fr Comment préférez-vous apprendre? /;
/open
...
/fr Est-ce que tu veux aider l’Académie du numérique? /;
/any
/en Participate in future learning opportunities /; /fr Participer aux opportunités d'apprentissage futures /;
/en Help us design content and delivery training /; /fr Aidez-nous à concevoir le contenu et la formation à la livraison /;
/en Provide us advice on leading DevOps practices /; /fr Fournissez-nous des conseils sur les meilleures pratiques de DevOps /;
